        ...
        return this.props.slides.map((slide, index) => {
           ...
           return (
              <tr key={id}>
                 ...
                 <td>{description}</td>
                 <td>
                    <button  onClick={this.props.editSlide.bind(this, id)} style={{ cursor: 'pointer', color: 'blue'}}>Edit</button>
                    {`  `}
        ...
        <div>           
           <table id='slides'>
              ...
              {this.props.slides.map((slide) => (
                  <SlideItem key={slide.id} slide={slide}  editSlide={this.props.editSlide} delSlide={this.props.delSlide}/>
                  ))}
